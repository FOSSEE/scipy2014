...
var Dajaxice = {
    ...
    test: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.test', 'POST', callback_function, argv, custom_settings);
    },

    user_login: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.user_login', 'POST', callback_function, argv, custom_settings);
    },

    submit_proposal: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.submit_proposal', 'POST', callback_function, argv, custom_settings);
    },

    user_register: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.user_register', 'POST', callback_function, argv, custom_settings);
    },

    user_logout: function(callback_function, argv, custom_settings){
        return Dajaxice.call('website.user_logout', 'POST', callback_function, argv, custom_settings);
    }
